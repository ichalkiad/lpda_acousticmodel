...
public:
    ...
    size_t read_ftrslabs(size_t frames, float* ftrs, float* labs);
    ...
    // frame have been lost.  Use read_ftrslabs() if you want both features
    // and labels
    size_t read_labs(size_t frames, float* labs);
...
inline size_t
QN_InFtrLabStream_PFile::read_labs(size_t frames, float* labs)
{
...
public:
    ...
    void write_labs(size_t frames, const float* labs);
