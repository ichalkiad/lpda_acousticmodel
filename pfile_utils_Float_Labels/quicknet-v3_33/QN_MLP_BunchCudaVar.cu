const char* QN_MLP_BunchCudaVar_rcsid =
    "$Header: /u/drspeech/repos/quicknet2/QN_MLP_BunchCudaVar.cu,v 1.6 2013/10/29 04:16:42 davidj Exp $";
...
void
QN_MLP_BunchCudaVar::devfree(const char* varname, void* devptr)
{
    cublasStatus e;
    e = cublasFree(devptr);
    if (e != CUBLAS_STATUS_SUCCESS)
