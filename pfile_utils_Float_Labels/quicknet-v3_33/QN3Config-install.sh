...
QN_BUILD_LIB_SPEC="-L/media/data/ichalkia/kaldi-trunk/tools/quicknet-v3_33 -lquicknet3 -lpthread -lm "
...
QN_BUILD_INC_SPEC="-I/media/data/ichalkia/kaldi-trunk/tools/quicknet-v3_33 -I/media/data/ichalkia/kaldi-trunk/tools/quicknet-v3_33"
